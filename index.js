 ...
 *
 * counter1 has functional scope, which means its variable will only be usable within the function, this will use less memory.  counter2 has global scope, the variable will be usable in other areas of your code, but will use more memory.
 *
 * 2. Which of the two uses a closure? How can you tell?
 *
 * Both functions have closure; counter1 has 2 closures, counter2 has 1 closure.
 *
 * 3. In what scenario would the counter1 code be preferable? In what scenario would counter2 be better?
 *
 * counter1 would be preferable if the variable is only going to be used once.  counter2 would be preferable if you are going to be using the variable multiple times.
 */

...
Closure is when a function has access to all of the information it needs to perform its task, i.e. all variables needed to make calculations are within the function's scope.
